...
public class ScriptRunner {
    ...
    private static final String SCRIPT_NAME = "./merge_users.sh";

    private static final String FILE_PATH_USERS_CSV = DATA_DIR.resolve("users.csv").toString();
    private static final String FILE_PATH_USERS_JSON = DATA_DIR.resolve("users.json").toString();
    ...
    public void executeScript() {
        runScript(FILE_PATH_USERS, FILE_PATH_USERS_JSON, FILE_PATH_USERS_CSV);
    }
