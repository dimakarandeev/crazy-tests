...
public class TestScenario {
    ...
    public TestScenario withUsersJsonFile(Map<String, String> loginToName) throws IOException {
        dataGenerator.createUsersJsonFile(loginToName);
        return this;
    }

    public TestScenario withUsersCsvFile(Map<String, String> loginToEmail) throws IOException {
        dataGenerator.createUsersCsvFile(loginToEmail);
        return this;
    }

    public TestScenario containsFullUser(String login, String name, String email) {
        resultAnalyser.containsFullUserRecord(login, name, email);
        return this;
    }

    public TestScenario doesNotContainFullUser(String login) {
        resultAnalyser.doesNotContainFullUserRecord(login);
        return this;
    }
}